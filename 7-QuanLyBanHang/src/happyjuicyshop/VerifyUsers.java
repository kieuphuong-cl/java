...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email){
        ...
        while(itr.hasNext()){
            ...
            if(!userObj.getEmail().equals("ad@gmail.com"))
            {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 60, 388, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 1140, 469));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -190, 1890, 1150));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(status.equals("true"))
            ...
            status = "true";
        int a = JOptionPane.showConfirmDialog(null,"Do you wanna change status of "+email+"","Select",JOptionPane.YES_NO_CANCEL_OPTION);
        if(a==0){
